...
from source.header_items import itp_type_one_handed_wpn, itp_type_goods, \
...
#identify coop admin panel
      ...
      (create_number_box_overlay, "$g_presentation_obj_coop_admin_panel_2", 20, 1000),
      (position_set_x, pos1, 390),
      (position_set_y, pos1, ":cur_y"),
...
###############
      ...
      (try_end),
      # (troop_get_slot, ":num_heroes", ":selected_troop", 100), # = 101 + all heroes on team
      ...
      # (store_sub, ":total_y", ":num_heroes", 101),
...
#      (assign, ":selected_troop_no", -1),
      ...
      # (try_for_range, ":i_button", multi_data_troop_button_indices_begin, ":end_cond"),
        ...
        # (store_sub, ":selected_troop_index", ":i_button", multi_data_troop_button_indices_begin), #find which button was clicked
        ...
        (try_begin),
          ...
          (try_begin),
            ...
            (try_begin),
              ...
              (show_item_details_with_modifier, ":item_no", ":item_imod", pos0, 0),
