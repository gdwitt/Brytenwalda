...
######################################gdw Somebody toggleable weapons start
...
common_wpn_swapping = [common_ai_order_toggle,common_ai_sanity_check,common_player_toggle]
#common_ai_random_toggle,

# Somebody's Alternate END###########################################

#################################Somebody common toggleables gdw
