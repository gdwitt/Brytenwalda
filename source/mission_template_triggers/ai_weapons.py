  ...
  (try_for_agents, ":agent_no"),
    ...
    (else_try),
      ...
      (try_for_range, ":item_slot", ek_item_0, ":end"),
        ...
        (neq, ":item_itp",itp_staff), ###gdw help for staffs  ERROR: invalid opcode -2147483648   -2147483648
...
common_wpn_swapping = [common_ai_order_toggle,common_ai_random_toggle,common_player_toggle]
