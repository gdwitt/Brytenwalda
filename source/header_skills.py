...
#skl_reserved_1           = 3
skl_entertain 			 = 3 #chief bardo entretenimiento
skl_reserved_2           = 4
skl_reserved_3           = 5
skl_reserved_4           = 6
skl_persuasion           = 7
...
knows_entertain_1            = 0x01 << (skl_entertain << 2)
knows_entertain_2            = 0x02 << (skl_entertain << 2)
knows_entertain_3            = 0x03 << (skl_entertain << 2)
knows_entertain_4            = 0x04 << (skl_entertain << 2)
knows_entertain_5            = 0x05 << (skl_entertain << 2)
knows_entertain_6            = 0x06 << (skl_entertain << 2)
knows_entertain_7            = 0x07 << (skl_entertain << 2)
knows_entertain_8            = 0x08 << (skl_entertain << 2)
knows_entertain_9            = 0x09 << (skl_entertain << 2)
knows_entertain_10           = 0x0A << (skl_entertain << 2)
knows_entertain_11           = 0x0B << (skl_entertain << 2)
knows_entertain_12           = 0x0C << (skl_entertain << 2)
knows_entertain_13           = 0x0D << (skl_entertain << 2)
knows_entertain_14           = 0x0E << (skl_entertain << 2)
knows_entertain_15           = 0x0F << (skl_entertain << 2)
...
knows_foraging_1              = 0x01 << (skl_foraging << 2)
knows_foraging_2              = 0x02 << (skl_foraging << 2)
knows_foraging_3              = 0x03 << (skl_foraging << 2)
knows_foraging_4              = 0x04 << (skl_foraging << 2)
knows_foraging_5              = 0x05 << (skl_foraging << 2)
knows_foraging_6              = 0x06 << (skl_foraging << 2)
knows_foraging_7              = 0x07 << (skl_foraging << 2)
knows_foraging_8              = 0x08 << (skl_foraging << 2)
knows_foraging_9              = 0x09 << (skl_foraging << 2)
knows_foraging_10             = 0x0A << (skl_foraging << 2)
knows_foraging_11             = 0x0B << (skl_foraging << 2)
knows_foraging_12             = 0x0C << (skl_foraging << 2)
knows_foraging_13             = 0x0D << (skl_foraging << 2)
knows_foraging_14             = 0x0E << (skl_foraging << 2)
knows_foraging_15             = 0x0F << (skl_foraging << 2)
...
knows_warrior_npc = knows_weapon_master_2|knows_ironflesh_1|knows_athletics_5|knows_power_strike_2|knows_riding_1|knows_shield_3|knows_inventory_management_2 #cambiado chief
knows_merchant_npc = knows_riding_2|knows_trade_3|knows_inventory_management_3 #knows persuasion
knows_tracker_npc = knows_weapon_master_1|knows_athletics_4|knows_spotting_2|knows_pathfinding_2|knows_tracking_2|knows_ironflesh_1|knows_inventory_management_2
...
knows_warrior_npc = knows_weapon_master_4|knows_ironflesh_5|knows_athletics_4|knows_riding_1|knows_power_strike_3|knows_shield_3|knows_power_throw_3
knows_cleric = knows_athletics_1|knows_trade_2|knows_wound_treatment_4|knows_first_aid_4|knows_surgery_4


knight_skills_1 = knows_weapon_master_7|knows_riding_5|knows_ironflesh_8|knows_power_strike_5|knows_athletics_6|knows_shield_3|knows_tactics_7|knows_prisoner_management_7|knows_leadership_7|knows_wound_treatment_8|knows_first_aid_8|knows_surgery_8|knows_power_throw_5 #F123
knight_skills_2 = knows_weapon_master_8|knows_riding_6|knows_ironflesh_9|knows_power_strike_5|knows_athletics_6|knows_shield_3|knows_tactics_8|knows_prisoner_management_8|knows_leadership_8|knows_wound_treatment_8|knows_first_aid_8|knows_surgery_8|knows_power_throw_5 #F123
knight_skills_3 = knows_weapon_master_8|knows_riding_7|knows_ironflesh_9|knows_power_strike_5|knows_athletics_6|knows_shield_3|knows_tactics_8|knows_prisoner_management_8|knows_leadership_9|knows_wound_treatment_8|knows_first_aid_8|knows_surgery_8|knows_power_throw_5 #F123
knight_skills_4 = knows_weapon_master_9|knows_riding_8|knows_ironflesh_10|knows_power_strike_5|knows_athletics_6|knows_shield_3|knows_tactics_9|knows_prisoner_management_9|knows_leadership_9|knows_wound_treatment_8|knows_first_aid_8|knows_surgery_8|knows_power_throw_5 #F123
knight_skills_5 = knows_weapon_master_10|knows_riding_9|knows_ironflesh_10|knows_power_strike_5|knows_athletics_6|knows_shield_3|knows_tactics_10|knows_prisoner_management_9|knows_leadership_10|knows_wound_treatment_9|knows_first_aid_8|knows_surgery_8|knows_power_throw_5 #TML Reduced power strike on all these here to 5 instead of 9 and 10. #F123
