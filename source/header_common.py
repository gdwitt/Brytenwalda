...
action_react_to_flail_attack           = 48 # gdw flail mod
#server events
...
##########################################################################################
######multiplayer chief
multiplayer_event_taunt_server                                = 116
multiplayer_event_message_server                              = 117
multiplayer_event_sound_made_by_player                             = 118
multiplayer_event_sound_at_player = 119
multiplayer_event_animation_at_player = 120
###### AoB/Taunt stuff:
multiplayer_event_player_play_sound = 121
multiplayer_event_player_play_animation = 122
multiplayer_event_message_client                              = 123
multiplayer_event_start_capitan_mode                            = 124 #chief capitan
##multiplayer_event_admin_set_initial_gold_multiplier2 = 124 #chief capitan
##multiplayer_event_admin_set_initial_gold_multiplier3 = 125 #chief capitan
###Add this to header_common.py, right before 'multiplayer message types' and
###after other multiplayer_event_x's.
rpw_shield_bash_server = 125
rpw_agent_play_sound_client = 126
...
multiplayer_message_type_start_capitan_mode            = 19 #chief capitan
...
multiplayer_game_type_lords_battle                 = 8 #chief capitan
#COOP chief################################################################
multiplayer_game_type_coop_battle            = 9
multiplayer_game_type_coop_siege             = 10
multiplayer_num_game_types                   = 11
#####################################################################
