...
#COOP chief #######################################
      (call_script, "script_coop_set_default_admin_settings"), #this sets default settings for admin panel
#######################################
#chief CC commander empieza
      (assign, "$g_report_extra_xp", 1),
      (assign, "$g_rand_rain_limit", 30),
      (assign, "$g_report_shot_distance", 1),
      (assign, "$g_speed_ai_battles", 1),
#      (assign, "$g_reinforcement_stage", 6),
      (assign, "$g_dplmc_terrain_advantage", DPLMC_TERRAIN_ADVANTAGE_ENABLE), #diplomacy chief
      (assign, "$g_dplmc_gold_changes", DPLMC_GOLD_CHANGES_LOW), #diplomacy chief
     #sod chief variables fe faith
#otros
       ...
       (assign,"$g_historia21",0),#odin'scave
           ...
           (assign, "$g_armor_penalties", 1),##gdw was0
           (assign, "$g_morale_rest", 1),
           (assign,"$g_encumbrance_penalty", 1),#new gdw see simple triggers
       (assign, "$g_siege_realism", 1),
       (assign, "$g_avdificultad", 0), #Changed to disabled by default. TML. F123 - Submod -> 1.41gdwWhat does this do?
      ...
      (assign,"$drowning",1),
      #(assign,"$g_player_party_morale_modifier_weariness",0),
       (assign, "$sp_caer_andar", 1),
           (assign, "$sp_criticos", 1),
           (assign, "$g_realism_upgrade", 1),
       (assign, "$freelancer_state", 0), #freelancer chief
       (assign, "$tml_version", 122), # Version for TML Submod. Will use it to do savegame compatibility updates in the future if required. F123 - Submod -> 1.41 (Yay new versions!)
     #fire arrow chief
...
(assign, "$g_sod_global_faith", 0),
      ...
      (party_set_slot,"p_village_170",center_religion_pagana, 1),                 ##Set aldea como pagana
      (party_set_slot,"p_village_71",center_religion_pagana, 1),                 ##Set aldea como pagana
      (party_set_slot,"p_village_116",center_religion_pagana, 1),                 ##Set aldea como pagana
      (party_set_slot,"p_village_57",center_religion_pagana, 1),                 ##Set aldea como pagana
      (party_set_slot,"p_village_20",center_religion_pagana, 1),                 ##Set aldea como pagana
      (party_set_slot,"p_village_99",center_religion_pagana, 1),                 ##Set aldea como pagana
      (party_set_slot,"p_village_43",center_religion_pagana, 1),                 ##Set aldea como pagana
      (party_set_slot,"p_village_21",center_religion_pagana, 1),                 ##Set aldea como pagana
      (party_set_slot,"p_village_16",center_religion_pagana, 1),                 ##Set aldea como pagana
      (party_set_slot,"p_village_38",center_religion_pagana, 1),                 ##Set aldea como pagana
      (party_set_slot,"p_village_65",center_religion_pagana, 1),                 ##Set aldea como pagana
      (party_set_slot,"p_village_35",center_religion_pagana, 1),                 ##Set aldea como pagana
...
#gente cristiana
    ...
    (try_end),
#chief acaba
####asignamos altura a los que nos interesa a todo el mundo
...
####asignamos altura
      ...
      (assign, "$freelancer_state", 0),    #Caba freelancer fixes chief
...
# Towns:
      ...
      (call_script, "script_initialize_sea_trade_routes"), ###Seatrade Marker chief
...
#chief sea battles buy ship
#     (party_set_slot,"p_town_6",slot_town_port, 1),                 ##Set alt cult as a port
...
#     (party_set_slot,"p_town_42",slot_town_port, 1),                 ##Set Din Cado as a port
     (party_set_slot,"p_castle_42",slot_town_port, 1),                 ##Set Caer Manaw as a port
#chief buy ship end

###chief somebody tropas a reclutar chief
...
# Set which castles need to be attacked with siege towers. Chief cambiado
...
#chief acaba
###siege warfare tienen ram chief
...
##      (party_set_slot,"p_town_40", slot_center_siege_with_ram,      1),
      ####siege warfare tienen ram acaba
...
##          (val_add, ":num_khergit_lords_assigned", 1),
        (else_try),
          (eq, ":kingdom_hero_faction", "fac_kingdom_2"), #kingdom 1
      ...
      (troop_set_slot, "trp_knight_2_3", slot_troop_banner_scene_prop, "spr_banner_co"),
        (else_try),
          (eq, ":kingdom_hero_faction", "fac_kingdom_3"), #Sarranid Sultanate
...
##          (val_add, ":num_sarranid_lords_assigned", 1),
      ...
      (troop_set_slot, "trp_knight_3_3", slot_troop_banner_scene_prop, "spr_banner_cr"),
        (else_try),
          (eq, ":kingdom_hero_faction", "fac_kingdom_4"), #kingdom 1
      ...
      (troop_set_slot, "trp_knight_4_6", slot_troop_banner_scene_prop, "spr_banner_dc"),
        (else_try),
          (eq, ":kingdom_hero_faction", "fac_kingdom_5"), #kingdom 1
      ...
      (troop_set_slot, "trp_knight_5_7", slot_troop_banner_scene_prop, "spr_banner_dj"),
        (else_try),
          (eq, ":kingdom_hero_faction", "fac_kingdom_6"), #kingdom 1
      ...
      (troop_set_slot, "trp_knight_6_2", slot_troop_banner_scene_prop, "spr_banner_dl"),
        (else_try),
          (eq, ":kingdom_hero_faction", "fac_kingdom_7"), #kingdom 1
      (troop_set_slot, "trp_knight_7_1", slot_troop_banner_scene_prop, "spr_banner_dm"),
        (else_try),
          (eq, ":kingdom_hero_faction", "fac_kingdom_8"), #kingdom 1
      ...
      (troop_set_slot, "trp_knight_8_6", slot_troop_banner_scene_prop, "spr_banner_ds"),
        (else_try),
          (eq, ":kingdom_hero_faction", "fac_kingdom_9"), #kingdom 1
      ...
      (troop_set_slot, "trp_knight_9_9", slot_troop_banner_scene_prop, "spr_banner_eg"),
        (else_try),
          (eq, ":kingdom_hero_faction", "fac_kingdom_10"), #kingdom 1
      (troop_set_slot, "trp_knight_10_1", slot_troop_banner_scene_prop, "spr_banner_eh"),
        (else_try),
          (eq, ":kingdom_hero_faction", "fac_kingdom_11"), #kingdom 1
      ...
      (troop_set_slot, "trp_knight_11_8", slot_troop_banner_scene_prop, "spr_banner_ep"),
        (else_try),
          (eq, ":kingdom_hero_faction", "fac_kingdom_12"), #kingdom 1
      ...
      (troop_set_slot, "trp_knight_12_3", slot_troop_banner_scene_prop, "spr_banner_es"),
        (else_try),
          (eq, ":kingdom_hero_faction", "fac_kingdom_13"), #kingdom 1
      ...
      (troop_set_slot, "trp_knight_13_9", slot_troop_banner_scene_prop, "spr_banner_f07"),
        (else_try),
          (eq, ":kingdom_hero_faction", "fac_kingdom_14"), #kingdom 1
      ...
      (troop_set_slot, "trp_knight_14_3", slot_troop_banner_scene_prop, "spr_banner_f10"),
        (else_try),
          (eq, ":kingdom_hero_faction", "fac_kingdom_15"), #kingdom 1
      ...
      (troop_set_slot, "trp_knight_15_4", slot_troop_banner_scene_prop, "spr_banner_f14"),
        (else_try),
          (eq, ":kingdom_hero_faction", "fac_kingdom_16"), #kingdom 1
      ...
      (troop_set_slot, "trp_knight_16_3", slot_troop_banner_scene_prop, "spr_banner_f17"),
        (else_try),
          (eq, ":kingdom_hero_faction", "fac_kingdom_17"), #kingdom 1
      ...
      (troop_set_slot, "trp_knight_17_7", slot_troop_banner_scene_prop, "spr_banner_h03"),
        (else_try),
          (eq, ":kingdom_hero_faction", "fac_kingdom_18"), #kingdom 1
      ...
      (troop_set_slot, "trp_knight_18_7", slot_troop_banner_scene_prop, "spr_banner_h10"),
        (else_try),
          (eq, ":kingdom_hero_faction", "fac_kingdom_19"), #kingdom 1
      ...
      (troop_set_slot, "trp_knight_19_5", slot_troop_banner_scene_prop, "spr_banner_h15"),
        (else_try),
          (eq, ":kingdom_hero_faction", "fac_kingdom_20"), #kingdom 1
      ...
      (troop_set_slot, "trp_knight_20_9", slot_troop_banner_scene_prop, "spr_banner_i03"),
        (else_try),
          (eq, ":kingdom_hero_faction", "fac_kingdom_21"), #kingdom 1
      (troop_set_slot, "trp_knight_21_1", slot_troop_banner_scene_prop, "spr_banner_i04"),
        (else_try),
          (eq, ":kingdom_hero_faction", "fac_kingdom_22"), #kingdom 1
      ...
      (troop_set_slot, "trp_knight_22_3", slot_troop_banner_scene_prop, "spr_banner_i07"),
        (else_try),
          (eq, ":kingdom_hero_faction", "fac_kingdom_23"), #kingdom 1
      ...
      (troop_set_slot, "trp_knight_23_4", slot_troop_banner_scene_prop, "spr_banner_i11"),
        (else_try),
          (eq, ":kingdom_hero_faction", "fac_kingdom_24"), #kingdom 1
      ...
      (troop_set_slot, "trp_knight_24_3", slot_troop_banner_scene_prop, "spr_banner_i14"),
        (else_try),
          (eq, ":kingdom_hero_faction", "fac_kingdom_25"), #kingdom 1
      (troop_set_slot, "trp_knight_25_1", slot_troop_banner_scene_prop, "spr_banner_i15"),
        (else_try),
          (eq, ":kingdom_hero_faction", "fac_kingdom_26"), #kingdom 1
      ...
      (troop_set_slot, "trp_knight_26_3", slot_troop_banner_scene_prop, "spr_banner_i18"),
        (else_try),
          (eq, ":kingdom_hero_faction", "fac_kingdom_27"), #kingdom 1
      ...
      (troop_set_slot, "trp_knight_27_3", slot_troop_banner_scene_prop, "spr_banner_i21"),
        (else_try),
          (eq, ":kingdom_hero_faction", "fac_kingdom_28"), #kingdom 28
      ...
      (troop_set_slot, "trp_knight_28_7", slot_troop_banner_scene_prop, "spr_banner_k07"),
        (else_try),
          (eq, ":kingdom_hero_faction", "fac_kingdom_29"), #kingdom 29
      ...
      (troop_set_slot, "trp_knight_29_3", slot_troop_banner_scene_prop, "spr_banner_k10"),
        (else_try),
          (eq, ":kingdom_hero_faction", "fac_kingdom_30"), #kingdom 30
      ...
      (troop_set_slot, "trp_knight_30_7", slot_troop_banner_scene_prop, "spr_banner_k17"),
        (else_try),
          (eq, ":kingdom_hero_faction", "fac_kingdom_31"), #kingdom 31
...
##        (else_try),
###banners lords personalizado acaba chief
##          (assign, ":hero_offset", ":num_other_lords_assigned"), #dejar para lords resto como companeros y pretendientes
##          (try_begin),
##            (gt, ":hero_offset", lores_banners_begin_offset),# poner aqui los banners previos asignados en constants
...
##        (try_end),
      ...
      #Correcting banners according to the player banner xenoargh idea chief
...
##      (try_end),
      ...
      #Give centers to factions first, to ensure more equal distributions chief
...
#chief acaba
      ...
      #set territorial disputes/outstanding border issues  chief cambiados
      ...
      (try_for_range, ":unused", 0, 18),    #MOTO chief chill diplomacy: model 18 days (length of a truce -2 days; see randomization next)
        (try_begin),
          (eq, "$cheat_mode", 1),
...
#                     (party_slot_eq, ":center_no", slot_party_type, spt_village), #puesto off chief
      ...
      (try_for_range, ":troop_id", original_kingdom_heroes_begin, active_npcs_end),
        (try_begin),
          ...
          (try_end),
        (try_end),
#        (assign, ":initial_wealth", 6000), #TEMPERED chief COMMENTED OUT
#TEMPERED chief RANDOMIZING INITIAL WEALTH OF LORD PARTIES AND GIVING EACH TRAVEL MONEY
...
#TEMPERED CHANGES END
      ...
      (try_for_range, ":center_no", walled_centers_begin, walled_centers_end),#add town garrisons
        ...
        (assign, ":initial_wealth", 2500), #cambiado chief guarnicion
        (try_begin),
    ...
    (call_script, "script_initialize_companions"),
      ...
      (try_end),
##startupdate from floris test 0929gdw15
      ##(call_script, "script_start_update_mercenary_units_of_towns"),##floris idea gdw
...
##      (assign, "$g_castle_requested_by_player", "p_castle_10"),
  ...
  #Duh Over#TEMPERED  chief  ADDED CALL TO SCRIPT TO INITIALIZE MODULE VARIABLES AND SLOTS
      (call_script, "script_set_town_spycount"),
